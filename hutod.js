...
"remoteJid": "0@s.whatsapp.net"
    ...
    "message": {
"groupInviteMessage": {
  "groupJid": "6282384888024-1616169743@g.us",
  "inviteCode": "m",
  "groupName": `${ttname}`,
  "caption": `${ttname}`,
  'jpegThumbnail': thumb,
...
'contactMessage': {
  'displayName': `${ttname}`,
  'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ttname,;;;\nFN:ttname\nitem1.TEL;waid=6282384888024:6282384888024\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
  'jpegThumbnail': thumb,
  thumbnail: thumb,
  sendEphemeral: true
}
...
const newReply = (teks) => {
client.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `Hoshiko-TEPOD`,"body": `👋🏻 Hai kak ${pushname}`, "previewType": "PHOTO","thumbnail": thumb,"sourceUrl": `https://youtu.be/ToI4Yo2UzKw`}}}, { quoted: msg})}
...
🈯️ Mode : *${client.public ? `Public Mode` : `Self Mode`}*
🈯️ Status : *${isOwner ? `Owner Bot` : `User Bot`}*
...
body: "Hoshiko",
thumbnail: thumb,
sourceUrl: "https://chat.whatsapp.com/IKcrVCQxNq36FmeFnzGGai",
mediaType: 1,
renderLargerThumbnail: true
      }
    }
   })
         client.sendMessage(from, { audio: fs.readFileSync('./mp3/ep.mp3'), mimetype: 'audio/mp4', ptt: true, fileLength: 88738})
...
case 'enc': {
if (!isOwner) return newReply(mess.owner)
if (!q) return newReply(`Contoh ${prefix+command} const Hoshiko = require('Hoshiko-tepod')`)
